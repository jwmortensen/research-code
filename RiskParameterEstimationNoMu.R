...
#         LogLike(prop.lstar.vec.911, temp.lstar.mu, Nk.911, E.911) - 
...
#         LogLike(prop.lstar.vec.death, temp.lstar.mu, Nk.death, E.death) - 
...
tm <- system.time(draws2 <- MHGibbs(50000, 1, init.lstar.911, init.lstar.death, init.lstar.mu, init.beta, 2))
